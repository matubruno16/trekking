...
const contenido = [
  ...
  },
  {
    ...
    descripcion: "El Monte Fitz Roy es un destino popular para los amantes del trekking debido a su imponente belleza y desafiante terreno. El trekking es considerado de dificultad media a alta, con senderos rocosos y empinados. El tiempo estimado suele ser de aproximadamente 8 a 10 horas. Los paisajes espectaculares, los glaciares y las lagunas de color turquesa son algunos de los aspectos más destacados de esta increíble aventura en la naturaleza patagónica.",
    tiempo: "10",
  },
  {
  ...
  },
  {
    ...
    descripcion: "El sendero para llegar a la laguna comienza en la base del Cerro Catedral y se extiende a lo largo de aproximadamente 11 kilómetros de ida y vuelta. La dificultad del trekking es moderada, con algunas pendientes pronunciadas pero accesibles para la mayoría de los excursionistas. El tiempo estimado es de aproximadamente 6 a 7 horas, dependiendo del ritmo y las paradas para descansar o disfrutar de las vistas panorámicas de los picos nevados y los bosques de lengas.",
    tiempo: "7",
  },
  {
    ...
    descripcion: "Mirador del Lago Roca ofrece vistas impresionantes de los lagos y montañas circundantes. La dificultad de este trekking es moderada, ya que no presenta terrenos extremadamente difíciles ni pendientes pronunciadas. Por lo general, lleva alrededor de 3 a 4 horas completar la caminata de ida y vuelta. Es importante llevar ropa adecuada para el clima cambiante y agua suficiente, ya que el clima en Tierra del Fuego puede ser impredecible. También se recomienda informarse sobre las condiciones del sendero antes de emprender la caminata.",
    tiempo: "4",
  }
];
...
export const SeccionTreking = () => {
  ...
  return (
    <section id="trekking" className="w-full pt-16 overflow-hidden">
